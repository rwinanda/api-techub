...
// Create Product SKU
exports.createProductSku = async(req, res, next) => {
    try {
        const { value_id, sku_name, price, stock } = req.body;
        const createdAt = new Date().toISOString();
        const updatedAt = createdAt;
        const productSku = await Database.db.query(
            "INSERT INTO product_sku (value_id, sku_name, price, stock, created_at, updated_at) VALUES ($1, $2, $3, $4,  to_timestamp($5, 'YYYY-MM-DD\"T\"HH24:MI:SS.MSZ'), to_timestamp($6, 'YYYY-MM-DD\"T\"HH24:MI:SS.MSZ')) RETURNING *", [value_id, sku_name, price, stock, updatedAt, createdAt]
        );
...
// Get All Product SKU
exports.getProductSku = async(req, res, next) => {
    try {
